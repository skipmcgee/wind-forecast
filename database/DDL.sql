-- MySQL Script generated by MySQL Workbench and modified by David McGee and Kurt Griessman
-- CS-340 Group 10 Project
-- Sun Apr 28 00:12:19 2024
...
CREATE TABLE IF NOT EXISTS `Dates` (
  ...
  PRIMARY KEY (`dateID`),
  UNIQUE INDEX `dateDateTime_UNIQUE` (`dateDateTime` ASC) VISIBLE)
ENGINE = InnoDB
...
CREATE TABLE IF NOT EXISTS `Forecasts` (
  ...
  `forecastWindGust` FLOAT NOT NULL,
